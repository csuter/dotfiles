...
" highlight groups
call <SID>X("Cursor", white, white, "")
"CursorIM
call <SID>X("Directory", progblue, "", "")
call <SID>X("DiffAdd",  white, "00aa00", "")
call <SID>X("DiffChange", white, black, "")
call <SID>X("DiffText",   black, "ffff00", "")
call <SID>X("DiffDelete", "aa0000", "aa0000", "")
call <SID>X("ColorColumn", "", "1f1f1f", "")
"ErrorMsg
call <SID>X("VertSplit", "dddddd", "dddddd", "reverse")
call <SID>X("Folded", "ffd700", "4d4d4d", "")
call <SID>X("FoldColumn", "d2b48c", "4d4d4d", "")
call <SID>X("IncSearch", white, progblue, "")
call <SID>X("LineNr", "888888", "222222", "")
call <SID>X("ModeMsg", progblue, "", "")
call <SID>X("MoreMsg", "22dd88", "", "")
call <SID>X("NonText", "444444", black, "bold")
call <SID>X("Question", "00ff7f", "", "")
call <SID>X("Search", white, progblue, "")
...
"Scrollbar
"Tooltip
call <SID>X("Pmenu", "dddddd", progblue, "")
call <SID>X("PmenuSel", white, "66aaff", "")

" syntax highlighting groups
call <SID>X("Comment", progblue, "", "")
...
call <SID>X("MatchParen", white, progblue, "")

call <SID>X("CocFloating", white, "225599", "")
